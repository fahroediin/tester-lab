 ...
 */
exports.configRoutes.get('/config', auth_middleware_js_1.authenticateJWT, (req, res) => {
    try {
 ...
 */
exports.configRoutes.post('/config', auth_middleware_js_1.authenticateJWT, auth_middleware_js_1.requireAdmin, (req, res) => {
    try {
